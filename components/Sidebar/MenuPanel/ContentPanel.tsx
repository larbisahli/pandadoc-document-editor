...
const ContentPanel = ({ handleDisplayPanelToggle }: Props) => {
  return (
    <>
      <div className="flex min-h-[35px] items-center pr-[10px] pl-4">
        <div className="flex-1">
          <div className="text-sm font-semibold text-gray-600">Content</div>
        </div>
      ...
      <div className="flex items-center justify-center px-4">Menu Content</div>
    </>
  );
};
