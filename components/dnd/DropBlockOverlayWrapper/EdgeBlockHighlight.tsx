...
const LINES: Array<[DropSide, string]> = [
  [
    DropSide.Top,
    "w-[99%] h-[2px] top-[-7] left-0 right-0 mx-auto -translate-y-2",
  ],
  [
    DropSide.Left,
    "h-[99%] w-[2px] top-0 left-[-7] bottom-0 my-auto -translate-x-2",
  ],
  [
    DropSide.Right,
    "h-[99%] w-[2px] top-0 right-[-7] bottom-0 my-auto translate-x-2",
  ],
  [
    DropSide.Bottom,
    "w-[99%] h-[2px] bottom-[-7] left-0 right-0 mx-auto translate-y-2",
  ],
];
