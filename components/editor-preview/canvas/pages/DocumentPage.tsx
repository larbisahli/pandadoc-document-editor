...
const DocumentPage = ({ pageId }: DocumentPageProps) => {
  ...
  return (
    <PageContext value={value}>
      <div className="page-break relative mb-[5px] h-full">
        <div className="avoid-break h-full">
          <div className="relative mx-auto flex h-full min-h-[1065px] w-[816px] flex-col bg-white transition-all will-change-transform">
            {/* Document-header */}
            <DocumentHeader />
            {/* Document-body */}
            <div
